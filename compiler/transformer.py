...
class Transformer(lark.Transformer):
    ...
    def notequals(self, tree):
        ...
        eq_children = [
            ...
            'EQUALS',
            typed_tree('m_args', tree.children[1:]) #argument (RHS)
        ]
        ...
        new_children = [
            ...
            'NEGATE',
            typed_tree('m_args', []) #boolean negation has no arguments
        ]
    ...
    def op_transform(self, data, children, meta):
        ...
        new_children = [
            ...
            typed_tree('m_args', children[1:]) #argument object, if provided
        ]
        return typed_tree('m_call', new_children)
    ...
    def assign_op(self, data, children, meta):
        ...
        method_children = [
            ...
            typed_tree('m_args', [right]) #argument subtree
        ]
